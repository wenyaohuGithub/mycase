...
import com.hu.cm.security.AuthoritiesConstants;
import com.hu.cm.service.MailService;
import com.hu.cm.service.UserService;
import com.hu.cm.web.rest.admin.AccountResource;
...
public class AccountResourceTest {
    ...
    public void testRegisterAdminIsIgnored() throws Exception {
        ...
        assertThat(userDup.get().getRoles()).hasSize(1)
            .containsExactly(roleRepository.findOne(AuthoritiesConstants.USER));
    }
}
