...
class AddressGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Address entity")
        ...
        .repeat(2) {
            ...
            .post("/api/addresss")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "address_line_1":"SAMPLE_TEXT", "address_line_2":"SAMPLE_TEXT", "city":"SAMPLE_TEXT", "province":"SAMPLE_TEXT", "country":"SAMPLE_TEXT", "postal_code":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
