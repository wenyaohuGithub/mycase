...
class OrganizationGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Organization entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "active":null, "session_timeout":"0", "smtp_enabled":null, "smtp_server_address":"SAMPLE_TEXT", "smtp_username":"SAMPLE_TEXT", "smtp_password":"SAMPLE_TEXT", "smtp_port":"0"}""")).asJSON
            .check(status.is(201))
